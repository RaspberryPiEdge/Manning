...
def main():
  ...
  run('efficientnet_lite0_edgetpu.tflite', int(args.maxResults), args.scoreThreshold, int(args.numThreads), True, int(args.cameraId), args.frameWidth, args.frameHeight)
